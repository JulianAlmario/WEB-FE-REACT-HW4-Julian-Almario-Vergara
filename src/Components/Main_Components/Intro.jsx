  ...
  return (
    <section className="mx-5 max-[550px]:mx-1">
      ...
      <b className="text-blue-600 ">Compra Online</b> es una tienda en línea dedicada a ofrecer una amplia variedad de
        ...
        artículos para el hogar, con un enfoque en la satisfacción del cliente y
        envíos eficientes. Nos comprometemos a mantener una oferta actualizada y
        atractiva, además de ofrecer un servicio al cliente personalizado para
        hacer de cada compra una experiencia excepcional.
      </p>
    </section>
  );
}
